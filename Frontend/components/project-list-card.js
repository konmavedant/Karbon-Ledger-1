...
const ProjectListCard = ({ className = "" }) => {
    ...
    <section className={[styles.projectListCard, className].join(" ")}>
      ...
      <div className={styles.projectListing}>
        <div className={styles.projectListing6}>
          ...
          <div className={styles.approverejectButtons}>
            ...
            <div className={styles.rejectButton}>
              <div className={styles.rejectButtonChild} />
              <div className={styles.approve}>Reject</div>
            </div>
          </div>
        ...
        <div className={styles.projectListing5}>
          ...
          <div className={styles.approverejectButtons1}>
            <div className={styles.approveButton}>
              <div className={styles.approveButtonChild} />
              <div className={styles.approve}>Approve</div>
            </div>
        ...
        <div className={styles.projectListing3}>
          ...
          <div className={styles.approverejectButtons1}>
            <button className={styles.approveButton3}>
              <div className={styles.approveButtonChild} />
              <div className={styles.approve}>Approve</div>
            </button>
            <div className={styles.rejectButton}>
        ...
        <div className={styles.projectListing1}>
          ...
          <div className={styles.approverejectButtons5}>
            <div className={styles.approveButton}>
              <div className={styles.approveButtonChild} />
              <div className={styles.approve}>Approve</div>
            </div>
      ...
      <div className={styles.list}>
        ...
        <div className={styles.titles}>
          <div className={styles.acceptReject}>Accept/ Reject</div>
      ...
      <div className={styles.cardTitle}>
        <h3 className={styles.project1}>Project</h3>
      </div>
    </section>
  );
};
